...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference("Wine.count") do
      post wines_url, params: { wine: { brand: @wine.brand, color: @wine.color, quality: @wine.quality, vineyard: @wine.vineyard } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { brand: @wine.brand, color: @wine.color, quality: @wine.quality, vineyard: @wine.vineyard } }
