...
class StrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strain" do
    assert_difference("Strain.count") do
      post strains_url, params: { strain: { percentaje: @strain.percentaje, strain: @strain.strain } }
    end
  ...
  test "should update strain" do
    patch strain_url(@strain), params: { strain: { percentaje: @strain.percentaje, strain: @strain.strain } }
